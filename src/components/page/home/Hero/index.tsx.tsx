...
const Hero = () => {
  return (
    <section className="mobile:py-mobile_section_padding relative flex w-full flex-col gap-4xl laptop:py-desktop_section_padding">
      ...
      <div className="flex items-center container justify-between mobile:flex-col mobile:items-center mobile:gap-3xl tablet:flex-row">
        <div className="flex max-w-[600px] flex-col items-center gap-2xl mobile:gap-y-3xl tablet:items-start">
          <p className="h3-bold tablet:h2-bold laptop:h1-bold">
      ...
      <div className="hidden flex flex-col items-center gap-2xl px-0 py-3xl ">
        <p className="body-bold">Các đơn vị hỗ trợ</p>
        <div className="w-[100vw] mobile:overflow-hidden">
          <Swiper
