...
const ProjectCounting = () => {
  ...
  return (
    <SectionCard title={<ProjectCountingTitle />} description={description}>
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
        variants={containerVariants}
        className="flex h-[75px] w-full items-center overflow-hidden rounded-full bg-blue-100 text-sm font-semibold text-greyscale-negative body-bold laptop:h-[100px] laptop:h3-bold"
      >
        ...
        <div className="flex h-full w-2/5 items-center justify-center px-l text-center text-blue-500">
          Còn 6 <br className="taplet:hidden" /> dự án
        </div>
      </motion.div>
    </SectionCard>
  );
