  ...
  return (
    <div className="card-border-gradient overflow-hidden">
      <div className="flex w-full flex-col items-center justify-between gap-4xl overflow-hidden rounded-m bg-blue-10 p-3xl laptop:flex-row laptop:p-4xl">
        <div className="flex w-full tablet:basis-1/2 laptop:basis-[60%]">
          <div className="flex laptop:w-[80%] flex-col items-start gap-l tablet:gap-2xl laptop:gap-3xl">
            <h4 className="headline-bold tablet:h4-bold laptop:h3-bold">
            ...
            <Button size="medium" color="primary" variant="contained" classCustom='!btn__small'>
              Truy cập tài liệu miễn phí
            </Button>
          </div>
        </div>
        <div className="h-auto w-1/2 tablet:basis-[30%] laptop:basis-[20%]">
          <Image
