...
export const MobileMenu = ({ isOpen }: MobileMenuProps) => {
  ...
  return (
    <menu
      className={`absolute inset-0 z-50 flex h-[100dvh] w-full translate-y-desktop_header flex-col items-center justify-between overflow-hidden bg-white p-mobile_container ${isOpen ? 'mobile-menu--open' : 'mobile-menu--close'}`}
    >
